...
export default function ShopPage() {
  return <main><Header />
    ...
    <section className="purchase-note"><p className="eyebrow">BEFORE PURCHASE</p><h2>管理番号について</h2><p>お迎えいただいた株の管理番号を成長記録ページで検索すると、品種情報と育成履歴をご確認いただけます。</p><a href={siteHref('/records')}>成長記録を検索する →</a></section>
    <Footer />
  </main>;
}
