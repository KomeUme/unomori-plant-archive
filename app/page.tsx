...
export default function Home() {
  return <main>
    ...
    <section className="event-section event-section-pending"><div className="event-card event-card-pending"><p className="event-pending-copy"><span>NEXT EVENT</span>次回のイベント情報は未定です。</p></div></section>
