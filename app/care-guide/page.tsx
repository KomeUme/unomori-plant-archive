...
const seasonalCare = [
  { item: '育成状態', values: ['生育が始まる', '梅雨は生育を抑える\n高温時は緩慢', '再び生育が進む', '休眠・緩やか'] },
  { item: '植え替え', values: ['主な適期', '原則控える\n緊急時のみ', '補助的な適期', '原則控える\n緊急時のみ'] },
