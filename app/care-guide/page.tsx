...
const seasonalCare = [
  { item: '育成状態', values: ['生育が始まる', '高温時は調整', '再び生育が進む', '休眠・緩やか'] },
  { item: '植え替え', values: ['主な適期', '原則控える', '補助的な適期', '控える'] },
  { item: '遮光率', values: ['0〜30%', '30〜50%', '0〜30%', '基本不要'] },
  { item: '肥料', values: ['月1〜2回', '状態を見て調整', '月1〜2回', '基本不要'] },
  { item: '水やり頻度', values: ['徐々に増やす', '乾き方を見て調整', '徐々に増やす', '大きく控える'] },
];
